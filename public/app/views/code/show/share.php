            ...
            <ul>
                ...
                <li class="share-item share-tw">
                    <a href="https://twitter.com/share" class="twitter-share-button"
                       data-url="<?PHP echo home_url('code/share/' . $bit->slug . '/' . $bit->version); ?>"
                       data-text="<?PHP echo $settings->bit_title; ?>">Tweet</a>
                ...
                <li class="share-item share-fb">
                    ...
                    <div class="fb-like"
                         data-href="<?PHP echo home_url('code/share/' . $bit->slug . '/' . $bit->version); ?>"
                         data-send="false" data-layout="button_count" data-width="250" data-show-faces="false"></div>
                </li>
            </ul>

            <header>
                <div><?PHP echo _html($settings->bit_title); ?></p><?PHP if (isset($bit->version)) {
