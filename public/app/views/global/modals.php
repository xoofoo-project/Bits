...
<div id="unsaved-modal" class="modal">
    <div>
        ...
        <section class="modal-inner seperator">You have unsaved changes to your code. If you continue, your changes will
            be discarded
        </section>
        <footer class="modal-inner group">
        ...
        <section class="modal-inner seperator">
            <form id="pref-bit-form" class="bit-prefs">
                ...
                <label for="prefBitTitle">
                    Title
                    <input type="text" name="bit_title" id="prefBitTitle"
                           placeholder="<?PHP echo _html('Untitled', true); ?>">
                </label>
                <label for="prefBitDescription">
                    Description
                    <textarea name="bit_description" id="prefBitDescription"
                              placeholder="<?PHP echo _html('No Description', true); ?>"></textarea>
                </label>
...
<div id="pref-html-modal" class="modal">
    <div>
        <header class="modal-inner seperator">
            <p class="code-font">HTML Preferences</p> <span class="bit-close pull-right"
                                                            data-event="modal.close"></span>
        </header>
        <section class="modal-inner seperator">
            <form id="pref-html-form" class="bit-prefs">
                <label for="prefBodyTag">
                    Body Tag
                    <input type="text" name="html_bodyTag" id="prefBodyTag"
                           placeholder="<?PHP echo _html('<body>', true); ?>">
                </label>
                <label for="prefDocType">
                    Doc Type
                    <input type="text" name="html_docType" id="prefDocType"
                           placeholder="<?PHP echo _html('<!doctype html>', true); ?>">
                </label>
            </form>
        </section>
        <footer class="modal-inner group">
...
<div id="pref-javascript-modal" class="modal">
    <div>
        <header class="modal-inner seperator">
            <p class="code-font">Javascript Preferences</p> <span class="bit-close pull-right"
                                                                  data-event="modal.close"></span>
        </header>
        <section class="modal-inner seperator">
...
<div id="settings-reload-message-modal" class="modal">
    <div>
        ...
        <section class="modal-inner seperator">Your settings have been saved. They will come into effect upon reloading
            the page.
        </section>
        <footer class="modal-inner group">
            <input type="button" class="pull-left btn" value="Close" data-event="modal.close">
            <input type="button" class="pull-right btn btn-positive" value="Reload"
                   onclick="window.onbeforeunload=null;window.location.reload();">
        </footer>
    </div>
</div>
...
<div id="pref-editor-modal" class="modal">
    <div>
        <header class="modal-inner seperator">
            <p class="code-font">Editor Preferences</p> <span class="bit-close pull-right"
                                                              data-event="modal.close"></span>
        </header>
        <section class="modal-inner seperator">
            <form id="pref-editor-form" class="editor-prefs group">
                <div class="pull-left">
                    ...
                    <label for="editorThemes">
                        Theme
                        <select name="theme" id="editorThemes" data-event="code.action.preferences.editor.theme"
                                data-method="change">
        ...
        <footer class="modal-inner group">
            <input type="button" class="pull-right btn btn-positive" value="Save"
                   data-event="code.action.preferences.editor.set_settings">
        </footer>
    </div>
</div>
